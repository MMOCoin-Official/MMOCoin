...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "MMOCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"MMOCoin.com", "seed.MMOCoin.com"},
    {"MMOchain.info", "seed.MMOchain.info"},
    {"mophides.com", "seed.mophides.com"},
    {"dglibrary.org", "seed.dglibrary.org"},
//    {"MMOCoinpool.org", "dnsseed.MMOCoinpool.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. MMOCoin is probably already running."), addrBind.ToString().c_str());
        else
