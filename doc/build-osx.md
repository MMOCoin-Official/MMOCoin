Mac OS X MMOCoind build instructions
====================================
...
See `doc/readme-qt.rst` for instructions on building MMOCoin-Qt, the
...
Much of this may be outdated for MMOCoin.
...
1. Clone the github tree to get the source code and go into the directory.
        ...
        git clone git@github.com:MMOCoin-project/MMOCoin.git MMOCoin
        cd MMOCoin
...
For boost in MMOCoin, there are some ‘fun’ things you have to do:
...
1. Clone the github tree to get the source code and go into the directory.
        ...
        git clone git@github.com:MMOCoin/MMOCoin.git MMOCoin
        cd MMOCoin
...
It's now available at `./MMOCoind`, provided that you are still in the `src`
directory. We have to first create the RPC configuration file, though.

Run `./MMOCoind` to get the filename where it should be put, or just try these
commands:
...
Other commands:
    ...
    ./MMOCoind --help  # for a list of command-line options.
    ./MMOCoind -daemon # to start the MMOCoin daemon.
    ./MMOCoind help    # When the daemon is running, to get a list of RPC commands
